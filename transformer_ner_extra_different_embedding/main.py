...
def parse():
    ...
    parser.add_argument('-train_ner_tgt_file',default='../../data/cnndm/train.ner.src',help='data dir')
    parser.add_argument('-valid_ner_tgt_file',default='../../data/cnndm/val.ner.src',help='data dir')
    parser.add_argument('-test_ner_tgt_file',default='../../data/cnndm/test.ner.src',help='data dir')
