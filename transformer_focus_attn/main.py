...
def parse():
    ...
    parser.add_argument('-train_topk_file',default='../data/cnndm/train.top10',help='data dir')
    parser.add_argument('-valid_topk_file',default='../data/cnndm/val.top10',help='data dir')
    parser.add_argument('-test_topk_file',default='../data/cnndm/test.top10',help='data dir')
