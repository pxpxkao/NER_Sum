...
class EncoderDecoder(nn.Module):
    ...
    other models.
    """
    def __init__(self, encoder_sum, encoder_ner, decoder, generator, src_embed, tgt_embed):
    ...
    def forward(self, src, src_mask, tgt=None, tgt_mask=None, sum = True):
        ...
        if sum:
            ...
            out = self.decode(self.encode_sum(out_ner, src_mask), src_mask,
                            tgt, tgt_mask, src)
        else:
    ...
    def encode_sum(self, src, src_mask):
        return self.encoder_sum(src, src_mask)
