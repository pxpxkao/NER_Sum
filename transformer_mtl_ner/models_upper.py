...
class EncoderDecoder(nn.Module):
    ...
    other models.
    """
    def __init__(self, encoder_sum, encoder_ner, shared_encoder, decoder, generator, src_embed, tgt_embed):
    ...
    def forward(self, src, src_mask, tgt=None, tgt_mask=None, sum = True):
        ...
        if sum:
            ...
            out_enc = self.shared_encoder(out_sum, src_mask)
            out = self.decode(out_enc, src_mask,
                            tgt, tgt_mask, src)
        else:
            out_ner = self.encode_ner(src, src_mask)
            out_enc = self.shared_encoder(out_ner, src_mask)
