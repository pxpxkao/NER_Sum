...
class data_utils():
    def __init__(self, args):
        ...
        self.train_ner_path = 'data/train.txt'
        self.train_sum_path = 'data/train.article.txt'
    ...
    def data_yielder_ner(self, num_epoch = 1):
        ...
        for epo in range(num_epoch):
            ...
            for line1, line2 in zip(open('data/train.txt'), open('data/label.txt')):
    ...
    def data_yielder_sum(self):
        ...
        for epo in range(20):
            ...
            print("start epo %d" % (epo))
            # index = 0
            for line1,line2 in zip(open('data/train.article.txt'),open('data/train.title.txt')):
                vec1 = self.text2id(line1.strip(), 45)
