...
def parse():
    ...
    parser.add_argument('-train_ner_tgt_file',default='../../data/ents/train.ner.tgt',help='data dir')
    parser.add_argument('-test_ner_tgt_file',default='../../data/ents/test.ner.tgt',help='data dir')
    parser.add_argument('-load', default='./train_model/20w_model.pth', help= 'load: model_dir', dest= 'load_model')
